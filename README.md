...
- **v1.1.0** (最新) - モデル定義をJSON管理へ移行、GPT Image 2対応、モデル別設定UIに変更
- **v1.0.31** - Nano Banana 2モデル対応（モデル選択ドロップダウン追加、auto/0.5Kオプション対応）
- **v1.0.30** - localStorage容量管理改善（ライブラリ4MB上限、参照画像圧縮、使用率表示）
- **v1.0.29** - 画像生成状態の永続化機能（スマホを閉じても次回起動時に自動復元）
